...
export default function AdminProfile() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const toastId = toast.loading("Uploading optimized image to Cloudinary...")
    const res = await uploadImage(file, "portfolio-images", "avatars")

    if (res.success && res.url) {
      setProfile((prev) => ({ ...prev, avatar_url: res.url as string }))
      toast.success("Image uploaded to Cloudinary! Click Save Settings to apply.", { id: toastId })
    } else {
